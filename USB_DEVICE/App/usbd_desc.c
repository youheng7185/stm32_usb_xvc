...
#define USBD_VID     0x6CF0
#define USBD_LANGID_STRING     1033
#define USBD_MANUFACTURER_STRING     "Xilinx Inc."
#define USBD_PID_HS     0x0050
#define USBD_PRODUCT_STRING_HS     "Virtual Cable Clone"
#define USBD_CONFIGURATION_STRING_HS     "CDC Config"
#define USBD_INTERFACE_STRING_HS     "XVC-Compatible Bulk Interface"
...
__ALIGN_BEGIN uint8_t USBD_HS_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  ...
  0x02,
  0x00,                       /*bDeviceClass*/
  0x00,                       /*bDeviceSubClass*/ // changed both of device class to 0 based on st documentation
